...
export default function AdminDashboard() {
  ...
  const [showConfirmModal, setShowConfirmModal] = useState({ open: false, type: '', target: null })
  ...
  if (!isAdmin) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8">
        <div className="p-4 bg-red-50 dark:bg-red-950/20 rounded-full text-red-500 mb-4 animate-bounce">
  ...
  return (
    ...
    >
                              ...
                              return (
                                <tr key={item.id} className="hover:bg-slate-50/40 dark:hover:bg-slate-900/20 transition-all">
                                  ...
                                  <td className="px-6 py-4">
                                    <span className="capitalize px-2 py-0.5 text-xs font-medium rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200/50 dark:border-slate-700/50">
                                      {item.content_type}
                                    </span>
                                  </td>
                                  <td className="px-6 py-4">
                    ...
                    <div className="bg-white/80 dark:bg-slate-800/60 p-6 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm flex-1 flex flex-col">
                      ...
                      <div className="flex gap-2 mb-4">
                        <input 
                          ...
                          className="flex-1 px-3 py-2 text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 outline-none focus:ring-1 focus:ring-indigo-500"
                        />
                        <button
      ...
      {/* DETAIL MODAL FOR QUEUE REVIEW (EXPLAINABLE SPAM REPORT) */}
      <Modal
      ...
      >
        {selectedQueueItem && (
          <div className="space-y-6">
            ...
            {/* Split layout: content vs scoring */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              {/* Content Preview (7 Cols) */}
              ...
              {/* Explainable Scoring Engine Gauge & Details (5 Cols) */}
            ...
            <div className="flex flex-wrap items-center justify-end gap-2 border-t border-slate-100 dark:border-slate-800 pt-4">
              ...
              {selectedQueueItem.status === 'pending' && (
                <>
                  ...
                  >
                    <UserMinus className="w-4 h-4" /> Suspend Author
                  </button>
                  <button 
